...
import (
	"github.com/solana-foundation/solana-go/programs/token-2022/zkencryption"
	"github.com/solana-foundation/solana-go/programs/zk-elgamal-proof/encryption"
	"github.com/solana-foundation/solana-go/programs/zk-elgamal-proof/internal/bridge"
	"github.com/solana-foundation/solana-go/programs/zk-elgamal-proof/proofdata"
)
...
func TransferWithFeeSplitProofData(
	...
	currentBalanceAmountPlaintext, err := encryption.AeDecrypt(aesKey, currentAvailableBalanceAESCiphertext)
	if err != nil {
		return nil, err
	}
